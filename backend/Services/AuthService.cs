...
namespace backend.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<LoginResponseDto> LoginAsync(LoginRequestDto request)
        {
            ...
            {
                throw new backend.Exceptions.UnauthorizedException("Email o contraseña incorrectos");
            }
        ...
        public async Task<RefreshResponseDto> RefreshAsync(RefreshRequestDto request)
        {
            ...
            {
                throw new backend.Exceptions.UnauthorizedException("Refresh token invalido o expirado");
            }
