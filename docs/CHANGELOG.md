...
- Gallery: Navegación circular (primera ? ?ltima)
...
- CLS mejorado con dimensiones expl�citas en im�genes
...
- **Fase 1 (Auditor�a y limpieza):** 100% completada
...
- Estructura de carpetas reorganizada:
  ...
  - `config/` - Configuraci�n centralizada (6 archivos)
...
- **Fase 0 (Configuraci�n):** 100% completada
...
```bash
feat(navbar): agrega detección de scroll
fix(hero): corrige fetchPriority en imagen
docs: actualiza STATUS con progreso de Fase 2
refactor(gallery): mejora navegaci�n del lightbox
...
- Postman (testing API)
- Squoosh / Sharp (optimizaci�n de im�genes)
