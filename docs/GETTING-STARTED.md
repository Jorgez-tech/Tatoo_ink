...
- **Editor de c�digo** - Visual Studio Code (recomendado) o Visual Studio 2022
...
### 3. Verificar instalaci�n del backend
...
El proyecto usa **SQLite** por defecto. La base de datos se crea autom�ticamente en el primer arranque con datos de ejemplo.
...
### 3. Configuraci�n de email (opcional para producci�n)

**Opción A: SendGrid (recomendado para producci�n)**
...
El frontend estaró disponible en: `http://localhost:5173`
