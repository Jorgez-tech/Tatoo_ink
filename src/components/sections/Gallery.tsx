          ...
          >
            ...
            <div className="relative max-w-full max-h-full">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 md:p-8 bg-gradient-to-t from-black/80 to-transparent">
                <p className="text-white text-base sm:text-lg md:text-xl font-medium mb-1 sm:mb-2 line-clamp-2">{images[selectedImage].alt}</p>
                {images[selectedImage].artistName && (
                  <p className="text-gray-300 text-xs sm:text-sm uppercase tracking-wider">Artista: {images[selectedImage].artistName}</p>
                )}
                {images[selectedImage].description && (
                  <p className="text-gray-400 text-xs sm:text-sm mt-2 line-clamp-3 italic">"{images[selectedImage].description}"</p>
                )}
              </div>
            </div>
          </div>
